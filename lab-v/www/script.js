const WeatherApp = class {
    ...
    drawWeather() {
        ...
        if (this.currentWeather) {
            ...
            let weatherBlock = this.createWeatherBlock(dateTimeString, temperature, feelsLikeTemperature, iconName, description);
            document.getElementById('current-weather-container').appendChild(weatherBlock);
        }
        ...
        if (this.forecast && this.forecast.length > 0) {
            for (let i = 0; i < this.forecast.length; i++) {
                ...
                let weatherBlock = this.createWeatherBlock(dateTimeString, temperature, feelsLikeTemperature, iconName, description);
                document.getElementById('forecast-container').appendChild(weatherBlock);
            }
        }
    }
